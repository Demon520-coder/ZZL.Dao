...
namespace ZZL.Common
{
    ...
    public static class CustomAttributeHelper
    {
        ...
        public static string GetCustomAttributeValueWithNoCache<T>(this Type sourceType, Func<T, string> attributeValueAction, string name = null) where T : Attribute
        {
            return GetValue<T>(sourceType, attributeValueAction, name);
        }
        ...
        private static string GetAttributeValue<T>(Type sourceType, Func<T, string> attributeValueAction,
            string name, bool isCache = false) where T : Attribute
        {
